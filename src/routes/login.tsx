    ...
    <main className="grid min-h-dvh place-items-center bg-paper px-4 py-10">
      <div className="w-full max-w-md">
        ...
        <p className="mt-3 text-sm text-ink/80">
          Sports Lock is a private desk. Sign in with Google, X, or email. Access still needs an admin
          approval unless you are the owner. This site never places a bet.
        </p>
