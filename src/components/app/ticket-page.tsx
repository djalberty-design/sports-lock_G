  ...
  return (
    <div className="space-y-6">
      ...
      <section className="paper-card p-5 md:p-6">
        ...
        {pick.row?.inPlay ? (
          <p className="mt-3 text-xs uppercase tracking-wide text-gold">in-play · never The Call</p>
        ) : null}
        <SimLine pick={pick} />
        {pick.processSource ? (
...
function ParlayTicketView({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-3">
        <Button type="button" onClick={lockToLog}>
          Save to Log
        </Button>
        <Link
          to="/parlay"
