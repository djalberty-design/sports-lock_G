//#region node_modules/.nitro/vite/services/ssr/assets/options-Vkqe0eTA.js
var OPTION_CATALOG = [
	{
		kind: "sit",
		symbol: "SIT",
	...
	},
	{
		...
		symbol: "MAIN",
		title: "One game",
		promise: "The only live sports bet we will recommend: one before-the-game winner, spread, or over/under, in dollars, at Hard Rock Bet, when the price is fair or better.",
		howItWorks: [
...
function optionByKind(kind) {
	return OPTION_CATALOG.find((o) => o.kind === kind);
}
//#endregion
export { optionByKind as n, OPTION_CATALOG as t };
